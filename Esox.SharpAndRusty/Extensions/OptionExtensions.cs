...
public static class OptionExtensions
{
    ...
    /// <summary>
    ///     Flattens a nested option. If the outer option is <c>Some</c> and contains a <c>Some</c>, returns the inner
    ///     <c>Some</c>.
    ...
    extension<T>(Option<T> option)
    {
        ...
        /// <summary>
        ///     Gets the value contained in the option, or invokes a factory function to produce a default value if the option is
        ///     <c>None</c>.
        /// </summary>
        /// <param name="defaultFactory">A function that produces a default value if the option is <c>None</c>.</param>
        /// <returns>
        ///     The value contained in the option if it is <c>Some</c>; otherwise, the result of invoking
        ...
        /// <param name="mapper">
        ///     A function that transforms the value from type <typeparamref name="T" /> to type
        ...
        /// <returns>
        ///     The <see cref="Option{TResult}" /> returned by <paramref name="binder" /> if the option is <c>Some</c>;
        ///     otherwise, <c>None</c>.
        /// </returns>
        ...
        /// <summary>
        ///     Filters the option based on a predicate. Returns <c>Some</c> if the option is <c>Some</c> and the predicate returns
        ///     <c>true</c>; otherwise, returns <c>None</c>.
        /// </summary>
        ...
        /// <returns>
        ///     An option containing the result of applying the zipper function if both options are <c>Some</c>; otherwise,
        ///     <c>None</c>.
        /// </returns>
        ...
        /// <summary>
        ///     Executes a side effect action on the contained value if the option is <c>Some</c>, then returns the option
        ///     unchanged.
        ...
        {
            if (option is Option<T>.Some some) inspector(some.Value);
            return option;
        }
        ...
        /// <summary>
        ///     Converts the option to a <see cref="Result{T, E}" />.
        ///     Returns <c>Ok</c> if the option is <c>Some</c>; otherwise, returns <c>Err</c> with an error produced by the
        ///     factory.
        /// </summary>
        /// <typeparam name="E">The type of the error.</typeparam>
