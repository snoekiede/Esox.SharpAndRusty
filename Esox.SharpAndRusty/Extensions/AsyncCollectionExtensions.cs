...
public static class AsyncCollectionExtensions
{
    extension<T>(IEnumerable<Task<Option<T>>> taskEnumerable)
    {
        ...
        /// </code>
        /// </example>
        public async Task<Option<IEnumerable<T>>> SequenceAsync(
        ...
        /// </code>
        /// </example>
        public async Task<IEnumerable<T>> CollectSomeAsync(
            CancellationToken cancellationToken = default)
        {
            var results = new List<T>();
    ...
    {
        public async Task<Option<IEnumerable<U>>> TraverseAsync<U>(
        ...
        /// </code>
        /// </example>
        public async Task<Option<IEnumerable<U>>> TraverseParallelAsync<U>(
            Func<T, Task<Option<U>>> asyncSelector,
        ...
        /// </code>
        /// </example>
        public async Task<Result<IEnumerable<U>, E>> TraverseAsync<U, E>(
        ...
        /// </code>
        /// </example>
        public async Task<Result<IEnumerable<U>, E>> TraverseParallelAsync<U, E>(
            Func<T, Task<Result<U, E>>> asyncSelector,
            int maxDegreeOfParallelism = -1,
            CancellationToken cancellationToken = default)
        {
    ...
    extension<T, E>(IEnumerable<Task<Result<T, E>>> resultTasks)
    {
        ...
        /// </code>
        /// </example>
        public async Task<IEnumerable<T>> CollectOkAsync(
            CancellationToken cancellationToken = default)
        {
        ...
        /// // Ok([1, 2]) or Err("error message")
        /// </code>
        /// </example>
        public async Task<Result<IEnumerable<T>, E>> SequenceAsync(
            CancellationToken cancellationToken = default)
        {
            var results = new List<T>();
        ...
        /// </code>
        /// </example>
        public async Task<IEnumerable<E>> CollectErrAsync(
            CancellationToken cancellationToken = default)
        {
        ...
        /// </code>
        /// </example>
        public async Task<(List<T> successes, List<E> failures)> PartitionResultsAsync(
            CancellationToken cancellationToken = default)
        {
            var successes = new List<T>();
