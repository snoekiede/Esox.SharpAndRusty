...
public static class AsyncOptionExtensions
{
    extension<T>(Option<T> option)
    {
        ...
        /// </code>
        /// </example>
        public async Task<Option<T>> FilterAsync(
        ...
        /// </code>
        /// </example>
        public async Task<Option<T>> InspectAsync(
        ...
        /// </code>
        /// </example>
        public async Task<Option<T>> InspectNoneAsync(
        ...
        /// </code>
        /// </example>
        public async Task<Result<T, E>> OkOrElseAsync<E>(
